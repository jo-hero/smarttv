...
public class FileUtil {
    public static void openFile(File file) {
        ...
        Constants.APP.startActivity(intent);
    }
    ...
    public static void extractGzip(File target, File path) {
        ...
        try  {
            GZIPInputStream is = new GZIPInputStream(new BufferedInputStream(new FileInputStream(target)));
    ...
    public static Uri getShareUri(File file) {
        return Build.VERSION.SDK_INT < Build.VERSION_CODES.N ? Uri.fromFile(file) : FileProvider.getUriForFile(Constants.APP, Constants.APP.getPackageName() + ".provider", file);
    }
