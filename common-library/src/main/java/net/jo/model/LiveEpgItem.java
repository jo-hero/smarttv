...
public class LiveEpgItem {
    ...
    public void setSelected(LiveEpgItem item) {
    ...
    public String format() {
        ...
        if (getStart().isEmpty() && getEnd().isEmpty()) {
            return String.format("Playing: %s", getTitle());
        }
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (!(obj instanceof LiveEpgItem)) return false;
        LiveEpgItem it = (LiveEpgItem) obj;
